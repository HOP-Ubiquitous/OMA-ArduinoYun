/**
   ...
   Arduino LwM2M Client usage example

   Description:
      Example about the usage of the Arduino LwM2M Client library.
...
void setup() {
  ...
  if (lwm2mclient.connect("leshan.eclipse.org", "My-Ardino-Yun-Client")) {
